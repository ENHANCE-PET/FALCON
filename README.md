...
## 🦅 About FALCON 2.0
[![falconz Recommended Version](https://img.shields.io/badge/Recommended-pip%20install%20falconz%3D%3D2.0.18-9400D3.svg)](https://pypi.org/project/falconz/2.0.21/) [![Documentation Status](https://readthedocs.org/projects/falconz/badge/?version=latest)](https://falconz.readthedocs.io/en/latest/?badge=latest) ![Downloads](https://img.shields.io/pypi/dm/falconz?color=1B03A3) [![Discord](https://img.shields.io/badge/Discord-Join%20Chat-800080.svg?logo=discord&logoColor=white)](https://discord.gg/Q7ge3psMT9) [![YouTube](https://img.shields.io/badge/YouTube-MoCo%20Action-FF0000?logo=youtube&logoColor=white)](https://www.youtube.com/playlist?list=PLZQERorVWrbeNKLOdJMDi4lARvaK3ceeO)
...
```bash
pip install falconz==2.0.21 # stable recommended version
```
